...
class _CourseSearchState extends State<CourseSearch> {
  ...
  Term currentTerm = sl<MatricalCubit>().state.term;
  int currentYear = sl<MatricalCubit>().state.year;
  ...
  void search(String? query) {
    ...
    setState(() {
      searchFuture = getCourseSearch(query, currentTerm.databaseKey,
          currentYear, sl<MatricalCubit>().state.searchFilters);
      sl<MatricalCubit>().setLastSearch(query);
    });
  }
  ...
  void initState() {
    super.initState();
    if (sl<MatricalCubit>().state.lastSearch?.isNotEmpty ?? false) {
      search(sl<MatricalCubit>().state.lastSearch);
    }
  }
                  ...
                  child: DropdownMenu<Term>(
                      ...
                      onSelected: (term) async {
                        if (term != null) {
                          ...
                          currentTerm = term;
                          final removedAny =
                              await sl<MatricalCubit>().onTermYearChanged();
                          if (removedAny) {
                ...
                child: Padding(
                  ...
                  child: DropdownMenu<String>(
                      ...
                      onSelected: (year) async {
                        if (year != null) {
                          sl<MatricalCubit>().updateYear(int.parse(year));
                ...
                if (snapshot.connectionState == ConnectionState.none) {
                  ...
                  WidgetsBinding.instance.addPostFrameCallback((_) {
                    ...
                    setState(() {
                      ...
                      sl<MatricalCubit>().setLastSearch(null);
                    });
                  });
                  return const Center(child: CircularProgressIndicator());
                } else {
